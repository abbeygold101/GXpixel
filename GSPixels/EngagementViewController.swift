...
class EngagementViewController: UIViewController, UICollectionViewDelegateFlowLayout, UICollectionViewDataSource {

    @IBOutlet weak var engagementQuotelabel: UILabel!
    @IBOutlet weak var pWeddingCView: UICollectionView!
    ...
    override func viewDidLoad() {
        ...
        engagementQuotelabel.text = _engagementQuote
         getEngagementPictures()
    }
    ...
    override func prepare(for segue: UIStoryboardSegue, sender: Any?) {
        ...
        case "ShowDetail":
            ...
            guard let indexPath = pWeddingCView.indexPath(for: selectedPhoto) else {
    ...
    func getEngagementPictures() {
        for photo in allPhoto{
            if photo.tag == "Pre-wedding"{
